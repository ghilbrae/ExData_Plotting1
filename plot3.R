...
## Plot
plot(dat$Sub_metering_1, type = 'l', xaxt = 'n', ylab = 'Energy sub metering', xlab = '')
...
# Add weekday to X axis and legend
axis(side=1, labels=c("Thu", "Fri", "Sat"), at=c(0, start_fri, start_sat))
legend('topright', lty = 1, col = c('black', 'red', 'blue'), legend = c('Sub_metering_1', 'Sub_metering_2', 'Sub_metering_3'), text.width = 1000)
# Copy to file
dev.copy(png, width = 480, height = 480, file = 'figure/plot3.png')
dev.off()
